...
<div class="category-cards">
  <a href="{{ '/categories/math/' | relative_url }}" class="category-card">
  ...
  <a href="{{ '/categories/coding/' | relative_url }}" class="category-card">
    <span class="category-icon">💻</span>
    <h3>Coding</h3>
  ...
  <a href="{{ '/categories/music/' | relative_url }}" class="category-card">
    <span class="category-icon">🎹</span>
    <h3>Music</h3>
